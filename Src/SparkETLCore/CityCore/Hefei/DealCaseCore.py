...
<meta name="csrf-token" content="PBn0jTof7ww+ETtOjunmRrnGmHqmAMDpWCk1A5bKpQGfWqz5iLH3iFTBPfRAiD44qNReFJf8+8E9RnzZLuqarQ==" />
...
<form class="new_user gl-show-field-errors" aria-live="assertive" id="new_user" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="KnDlV3wPocTHvoy4t86as2J/VEkHPPnyemxJVJGAOfOJM70jzqG5QK1uigJ5r0LNc22SJzbAwtofAwCOKaAGXw==" /><div class="form-group">
